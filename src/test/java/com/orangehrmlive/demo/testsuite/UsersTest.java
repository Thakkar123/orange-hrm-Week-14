...
public class UsersTest extends TestBase {
    ...
    public void adminShouldAddUserSuccessFully() throws InterruptedException {
        ...
        addUserPage.addUserDetails("Admin", "Ananya Dash", "Ananya13", "Disabled", "Ananya123", "Ananya123");
    ...
    public void searchTheUserCreatedAndVerifyIt() throws InterruptedException {
        ...
        viewSystemUsersPage.clickOnAdminTab();
        viewSystemUsersPage.verifySystemUsersText("System Users");
        viewSystemUsersPage.inputUserName("Ananya13");
        ...
        viewSystemUsersPage.verifyUserInSearchResult("Ananya13");
    }
